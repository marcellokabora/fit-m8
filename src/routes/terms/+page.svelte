...
<div class="flex flex-col gap-5 px-5 pb-16 text-sm leading-relaxed text-text">
  ...
  <section class="flex flex-col gap-2">
    <h2 class="text-base font-bold text-text">2. Your account</h2>
    <p>
      You are responsible for the accuracy of the information on your profile
      and for keeping your login credentials secure. You may not impersonate
      another person, misrepresent your age, or create more than one account for
      deceptive purposes.
    </p>
  </section>
  ...
  <section class="flex flex-col gap-2">
    ...
    <ul class="list-disc space-y-1 pl-5">
      <li>
        ...
        violent, or that depicts anyone under 18.
      </li>
      <li>Harass, threaten, or abuse other users.</li>
      <li>Use the App for spam, scams, solicitation, or advertising.</li>
      <li>Attempt to access another user's account or private data.</li>
      <li>
        Reverse engineer, scrape, or interfere with the App's normal operation.
      </li>
    </ul>
    <p>
  ...
  <section class="flex flex-col gap-2">
    ...
    <p>
      ...
      users, including any in-person meetings, and should take reasonable safety
      precautions.
    </p>
  </section>
  ...
  <section class="flex flex-col gap-2">
    <h2 class="text-base font-bold text-text">7. Account deletion</h2>
    <p>
  ...
  <section class="flex flex-col gap-2">
    <h2 class="text-base font-bold text-text">8. Termination</h2>
    <p>
      We may suspend or terminate your access to the App if you violate these
      Terms or if we reasonably believe your conduct harms other users or the
      App.
    </p>
  </section>
  ...
  <section class="flex flex-col gap-2">
    <h2 class="text-base font-bold text-text">10. Changes to these terms</h2>
    <p>
      We may update these Terms from time to time. We will update the "Last
      updated" date above when we do. Continued use of the App after changes
