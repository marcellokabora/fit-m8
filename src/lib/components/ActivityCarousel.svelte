...
>
  <div
    class="pointer-events-none absolute inset-x-0 top-0 z-10 h-4 bg-linear-to-b from-bg to-transparent"
  ></div>
  <div
    class="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-4 bg-linear-to-t from-bg to-transparent"
  ></div>
  ...
  >
    {#each track as activity, i}
      ...
      >
        <span
          class={i === pos
            ? "flex items-center gap-2 rounded-full bg-primary/10 px-5 py-3 text-base font-semibold text-primary transition-transform duration-350"
