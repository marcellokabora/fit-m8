...
const MESSAGES = {
    en: {
        ...
        'profile.pushNotificationsHint': 'Get notified about new matches and messages',
        'profile.pushNotificationsBlocked': 'Blocked — enable notifications in your browser settings',
