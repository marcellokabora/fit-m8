...
const MESSAGES = {
    ...
    es: {
        'meta.description': 'Conecta con personas para hacer actividades cerca de ti', 'language.en': 'Inglés', 'language.es': 'Español', 'language.pt': 'Portugués',
    ...
    pt: {
        'meta.description': 'Combina com pessoas para praticar atividades perto de ti', 'language.en': 'Inglês', 'language.es': 'Espanhol', 'language.pt': 'Português',
        'nav.discover': 'Descobrir', 'nav.matches': 'Combinações', 'nav.profile': 'Perfil', 'common.all': 'Todos', 'common.any': 'Qualquer', 'common.search': 'Pesquisar', 'common.noResults': 'Sem resultados', 'common.showMore': 'Mais +', 'common.save': 'Guardar', 'common.saving': 'A guardar...', 'common.refresh': 'Atualizar', 'common.close': 'Fechar', 'common.back': 'Voltar', 'common.loading': 'A carregar...', 'common.chat': 'Chat', 'common.match': 'Match', 'common.format': 'Formato', 'common.level': 'Nível', 'common.gender': 'Género', 'common.orientation': 'Orientação', 'common.sports': 'Atividades', 'common.mySports': 'As minhas atividades', 'common.noActivities': 'Nenhuma atividade definida', 'common.profilePhoto': 'Foto de perfil', 'common.profilePhotoNumber': 'Foto de perfil {count}', 'common.removePhoto': 'Remover foto', 'common.previousPhoto': 'Foto anterior', 'common.nextPhoto': 'Foto seguinte', 'common.main': 'Principal', 'home.tagline': 'Encontra o teu parceiro de atividade ideal.', 'home.taglineSecond': 'Desliza. Combina. Joga.', 'home.google': 'Continuar com o Google', 'home.email': 'Continuar com email', 'home.signingIn': 'A iniciar sessão...', 'auth.welcome': 'Bem-vindo de volta', 'auth.join': 'Junta-te ao FIT-M8', 'auth.loginSubtitle': 'Inicia sessão para encontrar a tua próxima combinação', 'auth.registerSubtitle': 'Cria o teu perfil de atividade', 'auth.or': 'ou', 'auth.email': 'Endereço de email', 'auth.password': 'Palavra-passe', 'auth.confirmPassword': 'Confirmar palavra-passe', 'auth.loading': 'A carregar...', 'auth.signIn': 'Iniciar sessão', 'auth.createAccount': 'Criar conta', 'auth.noAccount': 'Ainda não tens conta?', 'auth.haveAccount': 'Já tens uma conta?', 'auth.signUp': 'Registar', 'auth.passwordMismatch': 'As palavras-passe não coincidem', 'errors.generic': 'Ocorreu um erro', 'onboarding.chooseLanguage': 'Escolhe o teu idioma', 'onboarding.languageHint': 'Podes alterar isto mais tarde nas definições', 'onboarding.permissionsTitle': 'Mantém-te a par', 'onboarding.permissionsHint': 'Vamos pedir-te algumas permissões para tudo ficar pronto', 'onboarding.notificationsTitle': 'Notificações push', 'onboarding.notificationsHint': 'Recebe avisos de novos matches e mensagens', 'onboarding.enableNotifications': 'Ativar notificações', 'onboarding.notificationsEnabled': 'Notificações ativadas', 'onboarding.notificationsBlocked': 'Bloqueadas — ativa-as nas definições do teu navegador', 'onboarding.locationTitle': 'Localização', 'onboarding.locationHint': 'Usada para encontrar parceiros de atividade perto de ti', 'onboarding.aboutYou': 'Sobre ti', 'onboarding.aboutYouHint': 'Conta-nos quem és', 'onboarding.name': 'O teu nome', 'onboarding.nameError': 'Indica apenas o teu primeiro nome', 'onboarding.bioOptional': 'Breve biografia (opcional)', 'onboarding.age': 'Idade', 'onboarding.birthdate': 'Data de nascimento', 'onboarding.underageError': 'Tens de ter pelo menos 18 anos para usar o FIT-M8', 'onboarding.yourSports': 'As tuas atividades', 'onboarding.sportsHint': 'Escolhe as atividades de que gostas', 'onboarding.selectAtLeastOneSport': 'Escolhe pelo menos uma atividade para continuar', 'onboarding.yourSettings': 'As tuas definições', 'onboarding.settingsHint': 'Escolhe o formato e o nível de cada atividade', 'onboarding.profilePhotos': 'Fotos de perfil', 'onboarding.photosHint': 'Adiciona até 3 fotos para que te possam encontrar. A primeira será a principal.', 'onboarding.photosRequired': 'Adiciona pelo menos uma foto para continuar', 'onboarding.makeItYours': 'Últimos retoques', 'onboarding.appearanceHint': 'Define a tua localização, notificações e o estilo da app', 'discover.filters': 'Filtros', 'discover.datingPreset': 'Encontros', 'discover.friendsPreset': 'Amizade', 'discover.trainerPreset': 'Treinador', 'discover.titleDating': 'Encontros', 'discover.titleFriends': 'Amizade', 'discover.titleTrainer': 'Treinadores', 'discover.ageRange': 'Intervalo de idade', 'discover.distance': 'Distância', 'discover.withinKm': 'Num raio de {count} km', 'discover.noMorePlayers': 'Não há mais jogadores', 'discover.matchTitle': 'É uma combinação!', 'discover.matchHint': 'Agora podem conversar e planear a sessão!', 'matches.subtitle': 'Pessoas com quem combinaste', 'matches.loadError': 'Não foi possível carregar as combinações', 'matches.emptyTitle': 'Ainda não há combinações', 'matches.emptyHint': 'Continua a deslizar para encontrares o teu parceiro de atividade!', 'matches.goDiscover': 'Ir para Descobrir', 'matches.fallback': 'Combinação', 'chat.fallbackTitle': 'Chat da combinação', 'chat.emptyTitle': 'Diz olá à tua combinação!', 'chat.emptyHint': 'Planeiem juntos a vossa atividade', 'chat.placeholder': 'Escreve uma mensagem...', 'profile.edit': 'Editar', 'profile.editTitle': 'Editar perfil', 'profile.bio': 'A tua biografia...', 'profile.signOut': 'Terminar sessão', 'profile.notFound': 'Utilizador não encontrado', 'profile.inCommon': 'Em comum', 'profile.addSport': 'Adicionar uma atividade', 'profile.allSports': 'Já adicionaste todas as atividades!', 'profile.addSportButton': 'Adicionar atividade', 'profile.resetSwipes': 'Repor deslizes', 'profile.resettingSwipes': 'A repor...', 'appearance.title': 'Aparência', 'appearance.light': 'Claro', 'appearance.dark': 'Escuro', 'appearance.appTheme': 'Tema da aplicação', 'location.enterCity': 'Introduz a tua cidade', 'location.editCity': 'Editar cidade', 'location.detecting': 'A detetar...', 'location.useMyLocation': 'Usar a minha localização', 'location.denied': 'Acesso à localização negado', 'location.unsupported': 'A geolocalização não é suportada neste dispositivo', 'location.detectFailed': 'Não foi possível detetar a tua localização', 'location.resolveFailed': 'Não foi possível encontrar a tua cidade', 'photo.chooseImage': 'Escolhe um ficheiro de imagem', 'photo.uploadFailed': 'Não foi possível carregar a imagem', 'activity.jogging': 'Corrida', 'activity.padel': 'Padel', 'activity.tennis': 'Ténis', 'activity.beachVolley': 'Voleibol de praia', 'activity.footvolley': 'Futevólei', 'activity.basketball': 'Basquetebol', 'activity.cycling': 'Ciclismo', 'activity.swimming': 'Natação', 'activity.hiking': 'Caminhada', 'activity.ping-pong': 'Ténis de mesa', 'activity.pickleball': 'Pickleball', 'activity.squash': 'Squash', 'activity.frescobol': 'Frescobol', 'activity.gym': 'Treino de ginásio', 'activity.calisthenics': 'Calistenia', 'activity.bodybuilding': 'Musculação', 'activity.crossTraining': 'Cross-training', 'activity.functionalFitness': 'Fitness funcional', 'activity.bootCamp': 'Bootcamp', 'activity.yoga': 'Yoga', 'activity.rockClimbing': 'Escalada', 'activity.golf': 'Golfe', 'activity.paddleboard': 'Paddleboard', 'activity.surf': 'Surf', 'activity.rollerblade': 'Patins em linha', 'activity.skateboard': 'Skate', 'activity.soccer': 'Futebol', 'format.all': 'Todos', 'format.1v1': '1 contra 1', 'format.2v2': '2 contra 2', 'format.group': '4+', 'skill.basic': 'Básico', 'skill.medium': 'Médio', 'skill.expert': 'Perito', 'gender.male': 'Masculino', 'gender.female': 'Feminino', 'orientation.hetero': 'Hetero', 'orientation.gay': 'Gay'
    }
} as const;
...
const EXTRA_MESSAGES: Record<LanguageCode, Partial<Record<TranslationKey, string>>> = {
    ...
    pt: {
        ...
        'discover.activityPickerTitle': 'Escolhe as tuas atividades',
        'discover.activityPickerHint': 'Seleciona pelo menos uma atividade em comum para conectares e conversares',
        'profile.distanceAway': 'A {count} km',
        'intro.skip': 'Saltar',
        'intro.next': 'Seguinte',
        'intro.dating.title': 'Encontra um par',
        'intro.dating.body': 'Define os teus filtros de género e orientação para conheceres pessoas com quem te identifiques enquanto praticas as tuas atividades favoritas.',
        ...
        'premium.composeMessageTitle': 'Envia uma mensagem',
        'premium.composeMessageHint': 'Isto cria uma combinação assim que a enviares.',
        ...
        'common.delete': 'Eliminar',
        'sports.maxHint': 'Podes escolher até {max} atividades',
        'sports.maxReached': 'Atingiste o limite de {max} atividades',
        'sports.reorderHint': 'Arrasta para reordenar: as atividades mais acima dão-te mais prioridade em Descobrir para essa atividade',
        ...
        'premium.featureMoreSportsTitle': 'Adiciona mais atividades',
        'premium.featureMoreSportsHint': 'Até {max} atividades em vez de {free} — mais atividades, mais matches',
        ...
        'common.other': 'Outros',
        'activityGroup.racquet': 'Raquete e Padel',
        'activityGroup.fitness': 'Fitness, Força e Calistenia',
        'activityGroup.ballSports': 'Desportos de Bola e Equipa',
        'activityGroup.wheelSkate': 'Rodas e Skate',
        'activityGroup.mindBody': 'Mente, Corpo e Recuperação',
        'activityGroup.water': 'Desportos de Prancha e Água',
        'activityGroup.danceArts': 'Dança, Música e Artes Cénicas',
        'activityGroup.combat': 'Combate e Artes Marciais',
        'activity.pilates': 'Pilates',
        'activity.meditation': 'Meditação',
        'activity.breathwork': 'Trabalho de Respiração',
        'activity.salsa': 'Salsa',
        'activity.bachata': 'Bachata',
        'activity.kizomba': 'Kizomba',
        'activity.barre': 'Barre',
        'activity.poleDance': 'Pole Dance',
        'activity.trampoline': 'Trampolim',
        'activity.kayak': 'Kayak',
...
export function createTranslator(language: LanguageCode): Translator {
    ...
    // activity ids are camelCase (e.g. rockClimbing) and must not be lowercased before key lookup
