...
const MESSAGES = {
    en: {
        ...
        'premium.featureMoreSportsHint': 'Up to {max} sports instead of {free} — more sports, more matches',
...
const EXTRA_MESSAGES: Record<LanguageCode, Partial<Record<TranslationKey, string>>> = {
    ...
    es: {
        ...
        'premium.featureMoreSportsHint': 'Hasta {max} deportes en lugar de {free} — más deportes, más matches',
    ...
    pt: {
        ...
        'premium.featureMoreSportsHint': 'Até {max} desportos em vez de {free} — mais desportos, mais matches',
