...
const MESSAGES = {
    en: {
        ...
        'onboarding.photosHint': 'Add up to 3 photos so others can find you. The first one is your main photo.',
        'onboarding.photosRequired': 'Add at least one photo to continue',
