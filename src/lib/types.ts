...
export const ACTIVITIES = [
	...
	{ id: 'cycling', label: 'Cycling', emoji: '🚴', group: 'wheelSkate' },
	...
	{ id: 'paddleboard', label: 'Paddleboard', emoji: '🛶', group: 'water' },
	{ id: 'surf', label: 'Surfing', emoji: '🏄', group: 'water' },
	{ id: 'windsurf', label: 'Windsurfing', emoji: '⛵', group: 'water' },
	{ id: 'kitesurf', label: 'Kitesurfing', emoji: '🪁', group: 'water' },
	{ id: 'wingFoil', label: 'Wing Foiling', emoji: '🌬️', group: 'water' },
	{ id: 'paraWing', label: 'Parawing', emoji: '🪂', group: 'water' },
